...
<body>
    <header>
        <div class="header-top">
            ...
            <h2 id="privacy"><a href="">Privacy e termini</a></h2>
        </div>

        <div class="header-bottom">
            <nav>
                <ul>
                    <li class="header-nav-item"><a href="">Introduzione</a></li>
                    <li class="header-nav-item"><a href="">Norme sulla privacy</a></li>
                    <li class="header-nav-item"><a href="">Termini di servizio</a></li>
                    <li class="header-nav-item"><a href="">Tecnologie</a></li>
                    <li class="header-nav-item selected"><a href="">Domande frequenti</a></li>
                    <li class="header-nav-item user-account">
                        <a href="">
                            <div class="avatar">
                                <img src="https://avatars2.githubusercontent.com/u/66369557?s=60&v=4" alt="AZ85">
                                <span class="user-mail">zorberto@gmail.com</span>
                            </div>
                        </a>
                    </li>
                </ul>
    ...
    <main>
        <?php foreach ($faq as $key) {?>
            <div class="content">
                <h2 class="question"><?php echo $key['question']; ?></h2>
                <p class="answer"><?php echo $key['answer']; ?></p>
            </div>
        <?php }?>
    </main>
    ...
    <footer>
        <div class="container">
            <ul>
                <li class="footer-nav-item"><a href="">Google</a></li>
                <li class="footer-nav-item"><a href="">Tutto su Google</a></li>
                <li class="footer-nav-item"><a href="">Privacy</a></li>
                <li class="footer-nav-item"><a href="">Termini</a></li>
            </ul>
